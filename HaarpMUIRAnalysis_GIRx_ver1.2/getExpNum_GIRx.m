function [ DataNum4GIR, DataNum4SRIR, PulseCodingType ] = ...
               getExpNum_GIRx(varargin)
...
%
%
%   input: dir  - directory of text file GISRIDataNum_yyyymmdd.txt (char)
%          date - experiment date [yyyymmdd] (char)
%
%   output: DataNum4GIR  - data numbers for GIRx contained in .txt (numeric)
%           DataNum4SRIR - data numbers for SRIRx containted in .txt (cell)
%           PulseCodingType - pulse type (uCLP or CLP) (cell)
%
...
%%% file name
 ...
 FileNameChar  = [ p.Results.dir, filesep, ...
                    'GISRIDataNum_', p.Results.date, '.txt' ];
